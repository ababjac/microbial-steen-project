...
plot_auc(probs, y_test, 'AUC for '+label, label+'_AUC-nometa-nosmote-nc2.png')
...
plot_confusion_matrix(y_pred=y_pred, y_actual=y_test, title=label, filename=label+'_CM-nometa-nosmote-nc2.png')
