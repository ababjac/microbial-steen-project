...
regions = set(data['Ocean.region'].values.tolist())

labels = pd.DataFrame()
labels['site'] = data['site']

for region in regions:
    region_bool = [elem == region for elem in data['Ocean.region']]
    labels[region] = region_bool

#print(labels)
labels.to_csv('files/data/labels.csv')
